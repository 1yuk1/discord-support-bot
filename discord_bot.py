...
def _merge_pending_parts(parts):
    ...
    for part in parts:
        ...
        if part.get("author_is_bot"):
            author_is_bot = True
    # Уникальные куски подряд (если игрок продублировал одно и то же — один раз).
    merged_texts = []
    for text in texts:
...
async def on_message(message):
    ...
    # Склейка подряд идущих сообщений (спам «Привет» / «не могу зайти» / «помогите»)
    # в один запрос к AI вместо ответа на каждое.
